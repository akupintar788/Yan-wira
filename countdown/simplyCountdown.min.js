...
document.getElementById("my-form").addEventListener("submit", function (e) {
  e.preventDefault(); // Mencegah form submit biasa agar tidak reload halaman

  const form = new FormData(this); // Ambil data dari form
  const url = this.action; // Ambil URL tujuan pengiriman
  ...
  // Gunakan fetch API untuk mengirim data ke URL
  fetch(url, {
    method: "POST",
    body: form,
  })
